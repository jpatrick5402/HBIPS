...
int main (int argc, char *argv[]) {
    ...
    printf(R""""(
__/\\\________/\\\__/\\\\\\\\\\\__/\\\\\\\\\\\\________/\\\\\\\\\\\___
 _\/\\\_______\/\\\_\/////\\\///__\/\\\////////\\\____/\\\/////////\\\_
  _\/\\\_______\/\\\_____\/\\\_____\/\\\______\//\\\__\//\\\______\///__
   _\/\\\\\\\\\\\\\\\_____\/\\\_____\/\\\_______\/\\\___\////\\\_________
    _\/\\\/////////\\\_____\/\\\_____\/\\\_______\/\\\______\////\\\______
     _\/\\\_______\/\\\_____\/\\\_____\/\\\_______\/\\\_________\////\\\___
      _\/\\\_______\/\\\_____\/\\\_____\/\\\_______/\\\___/\\\______\//\\\__
       _\/\\\_______\/\\\__/\\\\\\\\\\\_\/\\\\\\\\\\\\/___\///\\\\\\\\\\\/___
        _\///________\///__\///////////__\////////////_______\///////////_____
...
void process_packet(u_char *user, const struct pcap_pkthdr* h, const u_char * bytes) {
    ...
    fprintf(fptr, "IP Address,Packet Count\n");
    for (int i = 0; i < IP_addr_table_size; i++) {
        place = get_place(&IP_hash_table, IP_addr_table[i]);
        fprintf(fptr, "%s,%d\n", IP_addr_table[i], IP_hash_table.table[place]);
    }
